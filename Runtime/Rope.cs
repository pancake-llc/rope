...
namespace Pancake.Rope
{
    ...
    public class Rope : MonoBehaviour
    {
        ...
        [Min(2)] public int totalNodes = 200;
        public int iterations = 80;
        public float nodeDistance = 0.1f;
        [Min(0.001f)] public float stepTime = 0.01f;
                        ...
                        */
                        ...
                        switch (col)
                        {
                            case CircleCollider2D c:
                                ci.colliderType = EColliderType.Circle;
                                ci.colliderSize.x = ci.colliderSize.y = c.radius;
                                break;
                            case BoxCollider2D b:
                                ci.colliderType = EColliderType.Box;
                                ci.colliderSize = b.size;
                                break;
                            default:
                                ci.colliderType = EColliderType.None;
                                break;
                        }
